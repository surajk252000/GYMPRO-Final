...
export class SlotBookingComponent implements OnInit {
  ...
  constructor(private slotBooking: SlotBookingService,   private sharedService:EmailshareService) {  }


  ngOnInit(): void {
    // console.log(this.email);
    this.email=this.sharedService.getUserEmailID();
    console.log(this.email);
  ...
  //   console.log("saurabh singh",bookingDateObj);
